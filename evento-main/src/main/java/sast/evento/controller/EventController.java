...
public class EventController {
     ...
     */
    @OperateLog("删除活动")
    @Permission(value = Auth.MANAGER, group = "event")
    @DeleteMapping("/info")
    ...
    @OperateLog("获取活动详情")
    @Permission(Auth.PUBLIC)/* 这里为public,eventId注解没什么用 */
    @GetMapping("/info")
     ...
     */
    @OperateLog("发起活动")
    @Permission(value = Auth.ADMIN, group = "event")
    @PostMapping("/info")
    ...
    @Permission(value = Auth.PUBLIC, group = "event")
